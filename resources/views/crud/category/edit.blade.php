                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                ...
                                <p>Edit Category name & details</p>
                              </div></a></li>
...
<form method="POST" action="{{ $isEdit ? route('admin.category.update', $category->id) : route('admin.category.store') }}">
  @csrf
  @if ($isEdit)
    @method('PUT')
  @endif
  ...
  <div class="col-md-12">
    <label class="form-label" for="validationProductTitle">Category Title</label>
    <input
      class="form-control"
      name="title"

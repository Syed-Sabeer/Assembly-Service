...
<div class="page-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Hero Banner List</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header card-no-border text-end">
                    <div class="card-header-right-icon"><a class="btn btn-primary f-w-500" href="{{route('admin.hero.add')}}"><i class="fa fa-plus pe-2"></i>Add Hero Banner</a></div>
                  </div>
                        ...
                        <table class="table" >
                          ...
                          <tbody>
                            ...
                            <tr class="product-removes">
                              ...
                              <td>
                                @if($hero->image)
                                  <img src="{{ asset( $hero->image) }}" alt="{{ $hero->title }}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 5px;">
                                @else
                                ...
                                <td>
                                <p class="c-o-light">{{$hero->title}}</p>
                              </td>
  ...
  <a class="square-white" href="{{ route('admin.hero.edit', $hero->id) }}">
    <svg>
  ...
  <form action="{{ route('admin.hero.destroy', $hero->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this hero?');" style="display:inline;">
    @csrf
    @method('DELETE')

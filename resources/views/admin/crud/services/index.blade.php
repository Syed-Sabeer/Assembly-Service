                        ...
                        <table class="table" >
                          <thead>
                            <tr>
                              ...
                              <th> <span class="c-o-light f-w-600">Background Image</span></th>
                          ...
                          <tbody>
                            ...
                            <tr class="product-removes">
                              ...
                              <td>
                                @if($service->bg_image)
                                  <img src="{{ asset($service->bg_image) }}" alt="Background Image" style="width: 50px; height: 50px; object-fit: cover;">
                                @else

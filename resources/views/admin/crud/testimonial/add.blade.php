                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                ...
                                <p>Add Testimonial name & details</p>
                              </div></a></li>
                        ...
                        <div class="tab-content custom-input" id="add-product-pills-tabContent">
                          <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                            <div class="sidebar-body">
                              <form class="row g-3 common-form" method="POST" action="{{ route('admin.testimonial.store') }}" >
                                @csrf
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Name</label>
                                  <input class="form-control" name="name" id="validationProductTitle" type="text" placeholder="Name" value="{{ old('name') }}">
                                </div>
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Type / Designation</label>
                                  <input class="form-control" name="type" id="validationProductTitle" type="text" placeholder="Type/Designation" value="{{ old('type') }}">
                                </div>
                              <div class="col-md-12">
    <label class="form-label" for="validationProductTitle">Review</label>
    <textarea 
        class="form-control" 
        name="review" 

                        ...
                        <ul class="sidebar-left-icons nav nav-pills" id="add-product-pills-tab" role="tablist">
                          <li class="nav-item"> <a class="nav-link active" id="detail-product-tab" data-bs-toggle="pill" href="#detail-product" role="tab" aria-controls="detail-product" aria-selected="false">
                              ...
                              <div class="product-tab-content">
                                <h6>Add Achievement Details</h6>
                                <p>Add Achievement name & details</p>
                              </div></a></li>
                        ...
                        <div class="tab-content custom-input" id="add-product-pills-tabContent">
                          <div class="tab-pane fade show active" id="detail-product" role="tabpanel" aria-labelledby="detail-product-tab">
                            <div class="sidebar-body">
                              <form class="row g-3 common-form" method="POST" action="{{ route('admin.achievement.store') }}" >
                                @csrf
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Achievement Title</label>
                                  <input class="form-control" name="title" id="validationProductTitle" type="text" placeholder="Title" value="{{ old('title') }}">
                                </div>
                                <div class="col-md-12">
                                  <label class="form-label" for="validationProductTitle">Achievement Year</label>
                                  <input class="form-control" name="year" id="validationProductTitle" type="text" placeholder="Year" value="{{ old('year') }}">
                                </div>
